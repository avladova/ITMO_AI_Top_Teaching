...
**Структура и содержание.** Дисциплина состоит из 8 модулей: [ЗАПОЛНИТЬ: названия модулей]. Обучение включает 32 ч. лекций,  32 ч. практических занятий, в т. ч. лабораторные работы, курсовой проект и 80 ч. самостоятельной работы и завершается экзаменом и защитой проекта.
